...
class CreatePcodeGvipTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gvip', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gvip');
	}
