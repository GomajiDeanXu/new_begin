...
class CreatePcodeTutoTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_tuto', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_tuto');
	}
