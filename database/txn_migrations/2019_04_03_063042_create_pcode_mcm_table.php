...
class CreatePcodeMcmTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_mcm', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_mcm');
	}
