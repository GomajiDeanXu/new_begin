...
class CreatePcodeGmTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gm', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gm');
	}
