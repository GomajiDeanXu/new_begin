...
class CreateCucardErrTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('cucard_err', function(Blueprint $table)
		{
			...
			$table->integer('amount')->default(0)->index('idx_amount')->comment('訂單金額');
	...
	{
		Schema::connection('transaction')->drop('cucard_err');
	}
