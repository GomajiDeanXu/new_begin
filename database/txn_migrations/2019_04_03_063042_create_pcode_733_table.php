...
class CreatePcode733Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_733', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_733');
	}
