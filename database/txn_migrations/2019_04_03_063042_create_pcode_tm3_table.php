...
class CreatePcodeTm3Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_tm3', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_tm3');
	}
