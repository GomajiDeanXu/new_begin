...
class CreatePcodeMg2Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_mg2', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_mg2');
	}
