...
class CreateEscardHistoryTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('escard_history', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('escard_history');
	}
