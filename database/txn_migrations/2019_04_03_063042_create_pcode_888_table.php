...
class CreatePcode888Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_888', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_888');
	}
