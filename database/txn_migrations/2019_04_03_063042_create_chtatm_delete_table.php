...
class CreateChtatmDeleteTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('chtatm_delete', function(Blueprint $table)
		{
...
');
	...
	{
		Schema::connection('transaction')->drop('chtatm_delete');
	}
