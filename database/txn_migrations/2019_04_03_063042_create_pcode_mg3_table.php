...
class CreatePcodeMg3Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_mg3', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_mg3');
	}
