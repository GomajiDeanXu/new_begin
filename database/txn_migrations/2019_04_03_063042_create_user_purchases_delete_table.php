...
class CreateUserPurchasesDeleteTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('user_purchases_delete', function(Blueprint $table)
		{
...
payment.agent_type');
	...
	{
		Schema::connection('transaction')->drop('user_purchases_delete');
	}
