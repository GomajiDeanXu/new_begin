...
class CreatePcodeGfriTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gfri', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gfri');
	}
