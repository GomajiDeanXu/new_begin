...
class CreatePcodeRi11Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_ri11', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_ri11');
	}
