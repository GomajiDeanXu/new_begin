...
class CreateUserPurchasesShopeetempTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('user_purchases_shopeetemp', function(Blueprint $table)
		{
			$table->bigInteger('purchase_id')->default(0)->comment('交易序號');
...
payment.agent_type');
	...
	{
		Schema::connection('transaction')->drop('user_purchases_shopeetemp');
	}
