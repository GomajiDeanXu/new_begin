...
class CreatePcodeEa04Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_ea04', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_ea04');
	}
