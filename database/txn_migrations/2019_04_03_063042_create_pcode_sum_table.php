...
class CreatePcodeSumTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_sum', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_sum');
	}
