...
class CreatePcodeEv4Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_ev4', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_ev4');
	}
