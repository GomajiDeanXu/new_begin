...
class CreateEscardTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('escard', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('escard');
	}
