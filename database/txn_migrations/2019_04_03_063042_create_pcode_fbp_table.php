...
class CreatePcodeFbpTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_fbp', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_fbp');
	}
