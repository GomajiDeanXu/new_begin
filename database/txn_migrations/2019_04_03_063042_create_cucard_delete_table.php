...
class CreateCucardDeleteTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('cucard_delete', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('cucard_delete');
	}
