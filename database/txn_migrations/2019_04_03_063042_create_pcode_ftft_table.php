...
class CreatePcodeFtftTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_ftft', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_ftft');
	}
