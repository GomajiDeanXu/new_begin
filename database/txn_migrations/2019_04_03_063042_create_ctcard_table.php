...
class CreateCtcardTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('ctcard', function(Blueprint $table)
		{
			$table->integer('ctcard_id', true);
	...
	{
		Schema::connection('transaction')->drop('ctcard');
	}
