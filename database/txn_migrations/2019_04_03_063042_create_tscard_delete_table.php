...
class CreateTscardDeleteTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('tscard_delete', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('tscard_delete');
	}
