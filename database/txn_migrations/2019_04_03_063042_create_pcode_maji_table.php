...
class CreatePcodeMajiTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_maji', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_maji');
	}
