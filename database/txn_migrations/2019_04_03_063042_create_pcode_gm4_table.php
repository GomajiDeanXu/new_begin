...
class CreatePcodeGm4Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gm4', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gm4');
	}
