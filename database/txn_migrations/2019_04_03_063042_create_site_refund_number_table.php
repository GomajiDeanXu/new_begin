...
class CreateSiteRefundNumberTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('site_refund_number', function(Blueprint $table)
		{
			...
			$table->integer('refund_number')->default(0)->comment('購買份數');
	...
	{
		Schema::connection('transaction')->drop('site_refund_number');
	}
