...
class CreatePcodeMg1Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_mg1', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_mg1');
	}
