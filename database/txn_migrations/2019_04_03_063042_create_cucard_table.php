...
class CreateCucardTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('cucard', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('cucard');
	}
