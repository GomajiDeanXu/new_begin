...
class CreatePcodeTm1Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_tm1', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_tm1');
	}
