...
class CreatePcode777Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_777', function(Blueprint $table)
		{
			...
			$table->char('pin', 7)->default('')->index('idx_pin')->comment('七碼英數字(大寫英文排除I,0，數字排除1,0)');
	...
	{
		Schema::connection('transaction')->drop('pcode_777');
	}
