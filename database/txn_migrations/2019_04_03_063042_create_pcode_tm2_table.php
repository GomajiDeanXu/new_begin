...
class CreatePcodeTm2Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_tm2', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_tm2');
	}
