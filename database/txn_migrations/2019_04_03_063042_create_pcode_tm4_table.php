...
class CreatePcodeTm4Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_tm4', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_tm4');
	}
