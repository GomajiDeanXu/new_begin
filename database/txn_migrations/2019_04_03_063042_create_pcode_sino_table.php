...
class CreatePcodeSinoTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_sino', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_sino');
	}
