...
class CreatePcodeAugTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_aug', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_aug');
	}
