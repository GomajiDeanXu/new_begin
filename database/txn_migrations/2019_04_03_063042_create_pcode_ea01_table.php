...
class CreatePcodeEa01Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_ea01', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_ea01');
	}
