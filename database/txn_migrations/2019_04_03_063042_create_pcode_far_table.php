...
class CreatePcodeFarTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_far', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_far');
	}
