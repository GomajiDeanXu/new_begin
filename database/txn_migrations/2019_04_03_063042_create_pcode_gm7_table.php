...
class CreatePcodeGm7Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gm7', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gm7');
	}
