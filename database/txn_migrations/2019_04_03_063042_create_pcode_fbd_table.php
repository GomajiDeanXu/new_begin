...
class CreatePcodeFbdTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_fbd', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_fbd');
	}
