...
class CreatePcodeEa03Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_ea03', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_ea03');
	}
