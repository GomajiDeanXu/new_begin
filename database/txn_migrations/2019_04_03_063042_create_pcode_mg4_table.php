...
class CreatePcodeMg4Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_mg4', function(Blueprint $table)
		{
			...
			$table->string('refer', 45)->default('')->index('refer');
		});
	}
	...
	{
		Schema::connection('transaction')->drop('pcode_mg4');
	}
