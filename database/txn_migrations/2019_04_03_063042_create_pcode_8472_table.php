...
class CreatePcode8472Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_8472', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_8472');
	}
