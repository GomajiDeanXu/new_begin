...
class CreateUserPurchasesHistoryTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('user_purchases_history', function(Blueprint $table)
		{
			$table->bigInteger('purchase_id')->comment('交易序號');
...
payment.agent_type');
	...
	{
		Schema::connection('transaction')->drop('user_purchases_history');
	}
