...
class CreatePcodeGm3Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gm3', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gm3');
	}
