...
class CreatePcodeEmptyTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_empty', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_empty');
	}
