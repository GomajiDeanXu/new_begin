...
class CreatePcodeRichTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_rich', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_rich');
	}
