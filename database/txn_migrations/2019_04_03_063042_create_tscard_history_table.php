...
class CreateTscardHistoryTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('tscard_history', function(Blueprint $table)
		{
			$table->integer('tscard_id')->unsigned()->primary();
	...
	{
		Schema::connection('transaction')->drop('tscard_history');
	}
