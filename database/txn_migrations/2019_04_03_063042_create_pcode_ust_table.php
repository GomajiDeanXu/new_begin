...
class CreatePcodeUstTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_ust', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_ust');
	}
