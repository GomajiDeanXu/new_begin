...
class CreatePcodeLuvmTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_luvm', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_luvm');
	}
