...
class CreatePcodeE2Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_e2', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_e2');
	}
