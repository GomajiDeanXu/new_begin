...
class CreatePcodeAppTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_app', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_app');
	}
