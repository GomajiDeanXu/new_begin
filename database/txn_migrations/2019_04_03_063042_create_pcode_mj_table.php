...
class CreatePcodeMjTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_mj', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_mj');
	}
