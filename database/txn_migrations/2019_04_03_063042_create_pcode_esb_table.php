...
class CreatePcodeEsbTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_esb', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_esb');
	}
