...
class CreatePcodeFbTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_fb', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_fb');
	}
