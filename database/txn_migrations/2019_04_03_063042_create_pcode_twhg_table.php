...
class CreatePcodeTwhgTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_twhg', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_twhg');
	}
