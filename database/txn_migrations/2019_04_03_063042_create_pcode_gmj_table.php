...
class CreatePcodeGmjTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gmj', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gmj');
	}
