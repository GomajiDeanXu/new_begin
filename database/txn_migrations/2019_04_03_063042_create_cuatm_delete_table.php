...
class CreateCuatmDeleteTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('cuatm_delete', function(Blueprint $table)
		{
...
');
			...
			$table->integer('amount')->unsigned()->default(0)->index('idx_amount')->comment('轉帳金額');
...
');
	...
	{
		Schema::connection('transaction')->drop('cuatm_delete');
	}
