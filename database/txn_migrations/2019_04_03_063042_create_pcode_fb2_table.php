...
class CreatePcodeFb2Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_fb2', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_fb2');
	}
