...
class CreateCtcardDeleteTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('ctcard_delete', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('ctcard_delete');
	}
