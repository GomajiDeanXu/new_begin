...
class CreatePcodeGm9Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gm9', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gm9');
	}
