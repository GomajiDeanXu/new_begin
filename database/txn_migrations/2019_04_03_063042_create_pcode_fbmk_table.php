...
class CreatePcodeFbmkTable extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_fbmk', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_fbmk');
	}
