...
class CreatePcodeGm8Table extends Migration {
	...
	public function up()
	{
		Schema::connection('transaction')->create('pcode_gm8', function(Blueprint $table)
		{
	...
	{
		Schema::connection('transaction')->drop('pcode_gm8');
	}
