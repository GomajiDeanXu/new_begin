...
class CreateMatchRewardFutureSinglelistingTable extends Migration {
	...
	public function up()
	{
		Schema::create('match_reward_future_singlelisting', function(Blueprint $table)
		{
	...
	{
		Schema::drop('match_reward_future_singlelisting');
	}
