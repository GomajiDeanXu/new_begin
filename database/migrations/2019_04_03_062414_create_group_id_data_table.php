...
class CreateGroupIdDataTable extends Migration {
	...
	public function up()
	{
		Schema::create('group_id_data', function(Blueprint $table)
		{
			$table->integer('id', true);
			$table->integer('index_id')->default(0)->index('idx_index_id')->comment('辨識ID gomaji.group_id_index.index_id');
