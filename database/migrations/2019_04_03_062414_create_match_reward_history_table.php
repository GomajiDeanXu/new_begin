...
class CreateMatchRewardHistoryTable extends Migration {
	...
	public function up()
	{
		Schema::create('match_reward_history', function(Blueprint $table)
		{
			$table->increments('mrh_id')->comment('系統流水號');
			...
			$table->integer('point_ts')->default(0)->comment('贈點日期時間');
	...
	{
		Schema::drop('match_reward_history');
	}
