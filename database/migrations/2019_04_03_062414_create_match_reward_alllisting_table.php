...
class CreateMatchRewardAlllistingTable extends Migration {
	...
	public function up()
	{
		Schema::create('match_reward_alllisting', function(Blueprint $table)
		{
	...
	{
		Schema::drop('match_reward_alllisting');
	}
