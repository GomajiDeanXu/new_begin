...
class CreateDynamicProductDiscountTable extends Migration {
	...
	public function up()
	{
		Schema::create('dynamic_product_discount', function(Blueprint $table)
		{
			...
			$table->dateTime('validated_from')->nullable();
			$table->dateTime('validated_from')
			->default('0000-00-00 00:00:00')->comment('有效起始時間')->change();
			$table->dateTime('validated_to')->nullable();
			$table->dateTime('validated_to')
			->default('0000-00-00 00:00:00')->comment('有效到期時間')->change();
			...
			->default('1970-01-01 00:00:00')->comment('建立時間')->change();
